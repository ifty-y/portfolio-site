				...
				<div className="relative w-screen mx-auto container gap-4 px-10 grid grid-cols-1 md:grid-cols-2 mb-10">
					...
					<motion.div
						...
						<p className="text-gray-600 text-justify title text-lg">
							Hey there, I&rsquo;m Iftekhar Ahmed Iftty, a
							...
							<span className="text-black font-medium">
								{" "}
								aspiring automobil engineer.
							</span>{" "}
							Originating from Cox's Bazar,
							I&rsquo;m currently pursuing Bachelor's
							degree at{" "}
							<span className="text-black font-medium">
							...
							My passion for cars and mechanics knows no
							bounds. Beyond the world of mechanical engineering, I find myself
							deeply immersed in the realms of design, simulation, and the fascinating universe of AI. I
