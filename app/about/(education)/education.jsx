					...
					<div className="px-5">
						...
						<div>
							...
							<h3 className="text-md font-normal mb-3">
								B.Sc.(Engg) in Mechanical Engineernig
							</h3>
							...
							<div className="flex items-center gap-2">
								<p className="text-justify">
									Aspiring to be an automibil engineer, I am
									currently pursuing a bachelor&rsquo;s degree
									in Mechanical Engineering at IUT. Fascinated by the world of
									machine, I am eager to learn and explore
									new things in the field of mechanical engineering.
								</p>
							</div>
							{/* add gpa in a style */}
