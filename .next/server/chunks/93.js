...
const _chalk = /*#__PURE__*/ _interop_require_default(__webpack_require__(9330));
...
const _staticgenerationbailout = __webpack_require__(2655);
const _draftmode = __webpack_require__(1726);
function headers() {
...
const _headers = __webpack_require__(4405);
const _constants = __webpack_require__(8988);
function getCookieParser(headers) {
    return function parseCookie() {
        ...
        const { parse: parseCookieFn } = __webpack_require__(3333);
...
function clearPreviewData(res, options = {}) {
    ...
    const { serialize } = __webpack_require__(3333);
...
const _apiutils = __webpack_require__(7338);
...
const _http = __webpack_require__(6317);
const _responsehandlers = __webpack_require__(7996);
...
const _cookies = __webpack_require__(9027);
const _nexturl = __webpack_require__(1689);
const _cleanurl = __webpack_require__(7769);
...
const _notfound = __webpack_require__(7667);
const _redirect = __webpack_require__(3586);
const _responsehandlers = __webpack_require__(7996);
...
const _routemodule = __webpack_require__(9034);
const _requestasyncstoragewrapper = __webpack_require__(7874);
const _staticgenerationasyncstoragewrapper = __webpack_require__(8595);
const _responsehandlers = __webpack_require__(7996);
const _http = __webpack_require__(6317);
const _patchfetch = __webpack_require__(7018);
const _tracer = __webpack_require__(4207);
const _constants = __webpack_require__(2959);
const _getpathnamefromabsolutepath = __webpack_require__(4300);
const _proxyrequest = __webpack_require__(2536);
const _resolvehandlererror = __webpack_require__(7800);
const _log = /*#__PURE__*/ _interop_require_wildcard(__webpack_require__(9992));
const _autoimplementmethods = __webpack_require__(1479);
const _getnonstaticmethods = __webpack_require__(4644);
const _requestcookies = __webpack_require__(5496);
const _routekind = __webpack_require__(1367);
const _parsedurlquerytoparams = __webpack_require__(9026);
...
const { requestAsyncStorage } = __webpack_require__(1410);
const { staticGenerationAsyncStorage } = __webpack_require__(480);
const serverHooks = __webpack_require__(8316);
const headerHooks = __webpack_require__(1511);
const { staticGenerationBailout } = __webpack_require__(2655);
const { actionAsyncStorage } = __webpack_require__(3989);
...
const _constants = __webpack_require__(2959);
const _tracer = __webpack_require__(4207);
const _constants1 = __webpack_require__(8988);
...
const _detectdomainlocale = __webpack_require__(8464);
const _formatnextpathnameinfo = __webpack_require__(7327);
const _gethostname = __webpack_require__(755);
const _getnextpathnameinfo = __webpack_require__(1987);
...
const _detectdomainlocale = __webpack_require__(3438);
const _formatnextpathnameinfo = __webpack_require__(7529);
const _gethostname = __webpack_require__(9602);
const _getnextpathnameinfo = __webpack_require__(5549);
const REGEX_LOCALHOST_HOSTNAME = /(?!^https?:\/\/)(127(?:\.(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)){3}|\[::1\]|localhost)/;
function parseURL(url, base) {
    return new URL(String(url).replace(REGEX_LOCALHOST_HOSTNAME, "localhost"), base && String(base).replace(REGEX_LOCALHOST_HOSTNAME, "localhost"));
}
...
const _cookies = __webpack_require__(3319); //# sourceMappingURL=cookies.js.map
...
const _cookies = __webpack_require__(9027); //# sourceMappingURL=cookies.js.map
...
const _nexturl = __webpack_require__(8335);
const _utils = __webpack_require__(7227);
const _error = __webpack_require__(5065);
const _cookies = __webpack_require__(6493);
...
const _uaparserjs = /*#__PURE__*/ _interop_require_default(__webpack_require__(7357));
function _interop_require_default(obj) {
    return obj && obj.__esModule ? obj : {
        default: obj
    };
...
const _addpathprefix = __webpack_require__(4068);
const _pathhasprefix = __webpack_require__(1355);
...
const _addpathprefix = __webpack_require__(9755);
const _pathhasprefix = __webpack_require__(4312);
function addLocale(path, locale, defaultLocale, ignorePrefix) {
    // If no locale was given or the locale is the default locale, we don't need
    // to prefix the path.
    if (!locale || locale === defaultLocale) return path;
...
const _parsepath = __webpack_require__(9513);
...
const _parsepath = __webpack_require__(570);
function addPathPrefix(path, prefix) {
    if (!path.startsWith("/") || !prefix) {
        return path;
    }
...
const _removetrailingslash = __webpack_require__(5897);
const _addpathprefix = __webpack_require__(4068);
const _addpathsuffix = __webpack_require__(7551);
const _addlocale = __webpack_require__(1535);
...
const _removetrailingslash = __webpack_require__(8046);
const _addpathprefix = __webpack_require__(9755);
const _addpathsuffix = __webpack_require__(9498);
const _addlocale = __webpack_require__(9568);
function formatNextPathnameInfo(info) {
    let pathname = (0, _addlocale.addLocale)(info.pathname, info.locale, info.buildId ? undefined : info.defaultLocale, info.ignorePrefix);
    if (info.buildId || !info.trailingSlash) {
        pathname = (0, _removetrailingslash.removeTrailingSlash)(pathname);
...
const _normalizelocalepath = __webpack_require__(7502);
const _removepathprefix = __webpack_require__(7363);
const _pathhasprefix = __webpack_require__(1355);
...
const _normalizelocalepath = __webpack_require__(2407);
const _removepathprefix = __webpack_require__(6303);
const _pathhasprefix = __webpack_require__(4312);
function getNextPathnameInfo(pathname, options) {
    var _options_nextConfig;
    const { basePath, i18n, trailingSlash } = (_options_nextConfig = options.nextConfig) != null ? _options_nextConfig : {};
...
const serverExports = {
    ...
    userAgent: (__webpack_require__(9882).userAgent)
};
